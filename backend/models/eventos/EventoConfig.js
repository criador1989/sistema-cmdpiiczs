...
const EventoConfigSchema = new mongoose.Schema({
  ...
  schemaVersion: { type: Number, default: 137 },
  ...
  bannerInternoMediaId: { type: String, default: '' },
  bannerInternoStorageProvider: { type: String, enum: ['', 'gridfs','s3'], default: '' },
  bannerInternoStorageKey: { type: String, default: '' },
  bannerInternoStorageUrl: { type: String, default: '' },
  percursoVideoMediaId: { type: String, default: '' },
  percursoVideoStorageProvider: { type: String, enum: ['', 'gridfs','s3'], default: '' },
  percursoVideoStorageKey: { type: String, default: '' },
  percursoVideoStorageUrl: { type: String, default: '' },
  percursoVideoNome: { type: String, default: '' },
  percursoVideoAtualizadoEm: { type: Date, default: null },
