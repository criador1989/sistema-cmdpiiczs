import { AVATARS, GAME_CONFIG } from '../config.js?v=20260718-v5-46-7-joystick-mobile-landscape';
import { GameState } from '../state.js?v=20260718-v5-46-7-joystick-mobile-landscape';
import { salvarAvatar } from '../api.js?v=20260718-v5-46-7-joystick-mobile-landscape';
