...
async function executar() {
  ...
  try {
    ...
    assert.equal(adminBody.versao, '1.12.3');
    ...
    console.log('Simulados V1.12.3: autenticação, participação parcial separada de base incompleta, idioma e performance aprovados.');
  } finally {
