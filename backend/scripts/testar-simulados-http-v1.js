...
async function executar() {
  ...
  try {
    ...
    assert.equal(adminBody.versao, '1.12.8');
    ...
    console.log('Simulados V1.12.8: autenticação, clareza dos relatórios, participação parcial, idioma e performance aprovados.');
  } finally {
